...
model; the research (`docs/claude.md`, `docs/gemini.md`) shows multi-agent memory must be treated as a
...
arXiv:2503.13657); distributed-memory critique in `docs/gemini.md`.
