// Package state derives orchestrator state by folding the event log. The fold
// is a pure function of the event stream (docs/v2/adr/001-event-sourced-truth.md):
